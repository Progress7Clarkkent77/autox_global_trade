...
//               width: double.infinity,
//               height: 800,
//               color: Colors.blue, // You can set any color you prefer
//               // Add child widgets if needed
//             ),
//             Container(
//               width: double.infinity,
...
//                                       fontWeight: FontWeight.bold), // Bold text
//                                 ),
//                                 child: const Text('Forex Screener'),
//                               ),
//                               TextButton(
//                                 onPressed: () {
//                                   // Navigate to Screen6
...
//                                       fontWeight: FontWeight.bold), // Bold text
//                                 ),
//                                 child: const Text('Crypto Pairs Screener'),
//                               ),
//                               TextButton(
//                                 onPressed: () {
//                                   // Navigate to Screen7
...
//                                       fontWeight: FontWeight.bold), // Bold text
//                                 ),
//                                 child: const Text('Crypto Coins Screener'),
//                               ),
//                               TextButton(
//                                 onPressed: () {
//                                   // Navigate to Screen8
...
//                                       fontWeight: FontWeight.bold), // Bold text
//                                 ),
//                                 child: const Text('Security vulnerability'),
//                               ),
//                               TextButton(
//                                 onPressed: () {
//                                   // Navigate to Screen10
...
//                                       fontWeight: FontWeight.bold), // Bold text
//                                 ),
//                                 child: const Text('Brokerage integration'),
//                               ),
//                               TextButton(
//                                 onPressed: () {
//                                   // Navigate to Screen7
