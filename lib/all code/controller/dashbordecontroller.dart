...
import '../CommonWidgets/comuncard2.dart';
...
class DashBordeController extends GetxController implements GetxService {
  ...
  List cards1 = [
    const ComunCard(
        price: "1,077.3 USD",
        color1: Color(0xff0CAF60),
        color2: Color(0xff4ADE80),
        subtitle: "Main Account",
        pr: 0.4),
    const ComunCard(
        price: "3,233.3 USD",
        color1: Color(0xff26A17B),
        color2: Color(0xff2DD4BF),
        subtitle: "Trading Account",
        pr: 0.7),
    const ComunCard(
        price: "423.3 USD",
        color1: Color(0xffFB774A),
        color2: Color(0xffFFC837),
        subtitle: "Margin Account",
        pr: 0.3),
    const ComunCard(
        price: "1,563.3 USD",
        color1: Color(0xffED6167),
        color2: Color(0xffDD3333),
