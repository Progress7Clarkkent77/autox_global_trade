              ...
              builder: (context, setState){
                ...
                children: [
                 ...
                 ListTile(
                   ...
                   child: Text("Your details".tr,style: Typographyy.bodyMediumSemiBold.copyWith(color: notifire.getTextColor))),
                   subtitle: Transform.translate(
                       offset: const Offset(-20, 2),
                       child: Text("Important account details".tr,style: Typographyy.bodySmallMedium.copyWith(color: notifire.getGry500_600Color))),
                 ),
                 ListTile(
                   onTap: () {
                     Get.back();
                   ...
                   subtitle: Transform.translate(
                       offset: const Offset(-20, 2),
                       child: Text("Setup 2FA for more security".tr,style: Typographyy.bodySmallMedium.copyWith(color: notifire.getGry500_600Color))),
                   title: Transform.translate(
                       offset: const Offset(-20, 0),
                       child: Text("2FA security".tr,style: Typographyy.bodyMediumSemiBold.copyWith(color: notifire.getTextColor))),
                 ),
                 ListTile(
                   onTap: () {
                     Get.back();
                   ...
                   subtitle: Transform.translate(
                       offset: const Offset(-20, 2),
                       child: Text("Invite your friends and earn rewards".tr,style: Typographyy.bodySmallMedium.copyWith(color: notifire.getGry500_600Color))),
                   title: Transform.translate(
                       offset: const Offset(-20, 0),
                       child: Text("Referrals".tr,style: Typographyy.bodyMediumSemiBold.copyWith(color: notifire.getTextColor))),
                 ),
                 ListTile(
                   onTap: () {
                     Get.back();
                   ...
                   subtitle: Transform.translate(
                       offset: const Offset(-20, 2),
                       child: Text("View additional settings".tr,style: Typographyy.bodySmallMedium.copyWith(color: notifire.getGry500_600Color))),
                   title: Transform.translate(
                       offset: const Offset(-20, 0),
                       child: Text("Account settings".tr,style: Typographyy.bodyMediumSemiBold.copyWith(color: notifire.getTextColor))),
                 ),
                 ...
                 ListTile(
                   ...
                   title: Transform.translate(
                       offset: const Offset(-20, 0),
                       child: Text("Log out".tr,style: Typographyy.bodyMediumSemiBold.copyWith(color: notifire.getTextColor))),
                 ),
                 Divider(
                   color: notifire.getGry700_300Color,
                   height: 8,
