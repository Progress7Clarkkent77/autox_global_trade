          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: "Search...",
                hintStyle: Typographyy.bodyMediumRegular
                      ...
                      ListTile(
                        ...
                        leading: CircleAvatar(
                            ...
                            backgroundImage: AssetImage(
                                massageController.pepoleimage[index])),
                        title: Text(massageController.pepolename[index],
                            style: Typographyy.bodyLargeExtraBold
                                .copyWith(color: notifire.getTextColor),
                            overflow: TextOverflow.ellipsis),
                        trailing: Text(massageController.dates[index],
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _builchatui(
              contante:
                  "The exported video seems laggy, what can I do to fix it?"),
          _builchatui1(
              contante:
                  "Shut down other applications on your laptop to improve the animation."),
          _builchatui(contante: "Can it export in MP4 too?"),
          _builchatui1(
              contante:
                  "You can convert the .webm files in this video converter from VEED."),
          _builchatui(contante: "Can it export in MP4 too?"),
            ...
            child: Row(
              children: [
                SvgPicture.asset("assets/images/photo.svg",
                    height: 22, width: 22, color: notifire.getGry500_600Color),
                const SizedBox(
                  width: 8,
                ),
                ...
                SvgPicture.asset("assets/images/mood-smile.svg",
                    height: 22, width: 22, color: notifire.getGry500_600Color),
                const Spacer(),
                ElevatedButton(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
          ...
          ListTile(
            ...
            trailing: SizedBox(
                ...
                width: 22,
                child: SvgPicture.asset(
                  "assets/images/dots-h.svg",
                  color: notifire.getGry500_600Color,
                )),
          ),
          ListTile(
            title: Text("InvoiceZZ.pdf",
                style: Typographyy.bodyMediumSemiBold
                    .copyWith(color: notifire.getGry500_600Color)),
            leading: SizedBox(
                height: 22,
