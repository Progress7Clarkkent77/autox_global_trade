...
class _GetHelpState extends State<GetHelp> {
                      ...
                      children: [
                        ...
                        SizedBox(
                            ...
                            child: VerticalDivider(
                                width: 80, color: notifire.getGry700_300Color)),
                        Expanded(
                          flex: 5,
                          child: _buildCompo2(),
                        ),
  ...
  Widget _buildCompo2() {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Text("Holding balances, setting up cards debits, and using assets",
          style: Typographyy.bodyMediumMedium
              .copyWith(color: notifire.getGry500_600Color)),
      const SizedBox(
        height: 48,
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const Spacer(),
                    SvgPicture.asset("assets/images/tabler_tag.svg",
                        width: 20, height: 20),
                    const SizedBox(
                      width: 8,
                    ),
                    ...
                    SvgPicture.asset("assets/images/ike-outlined.svg",
                        width: 20, height: 20),
                    const SizedBox(
                      width: 8,
                    ),
