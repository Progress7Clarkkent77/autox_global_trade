                      ...
                      children: [
                        Expanded(
                          ...
                          child: Container(
                            ...
                            margin: EdgeInsets.all(padding),
                            child:
                                _buildDashBordUi2(width: constraints.maxWidth),
                          ),
                        ),
                      ],
                    )
                      ...
                      child: SizedBox(
                        child: Padding(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text("Today’s Crypto currency prices".tr,
                              ...
                              Text("The global crypto market cap is \$1.86T".tr,
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                        ...
                                        child: SvgPicture.asset(
                                            "assets/images/arrow-narrow-right.svg"),
                                      ),
                                    ],
                                  ))
                            ],
  ...
  Widget _buidlex1() {
    return Row(
      ...
      children: [
        Column(
          children: [
            GetBuilder<DashBordeController>(builder: (appBarController) {
                      ...
                      child: Center(
                        child: ListTile(
                          ...
                          trailing: Transform.translate(
                              ...
                              child: SvgPicture.asset(
                                  appBarController.ismenuopen
                                      ? "assets/images/chevron-up.svg"
                                      : "assets/images/chevron-down.svg")),
                          leading: CircleAvatar(
                            radius: 15,
                            backgroundImage: AssetImage(dashBordeController
                                .listOfCoin[dashBordeController.coinselecter]),
                            backgroundColor: Colors.transparent,
                          ),
                          title: Transform.translate(
                              ...
                              child: Text(
                                  appBarController
                                      .coinsName[appBarController.coinselecter],
                                  style: Typographyy.bodyLargeMedium
                                      .copyWith(color: notifire.getTextColor))),
                        ),
                      ),
            ...
            child: Center(
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintStyle: Typographyy.bodyLargeSemiBold
                      .copyWith(color: notifire.getTextColor),
                  hintText: "\$ 345",
                      ...
                      child: Center(
                        child: ListTile(
                          ...
                          trailing: Transform.translate(
                              ...
                              child: SvgPicture.asset(
                                  appBarController.ismenuopen1
                                      ? "assets/images/chevron-up.svg"
                                      : "assets/images/chevron-down.svg")),
                          leading: CircleAvatar(
                            radius: 15,
                            backgroundImage: AssetImage(dashBordeController
                                .listOfCoin[dashBordeController.coinselecter1]),
                            backgroundColor: Colors.transparent,
                          ),
                          title: Transform.translate(
                              offset: const Offset(-8, 0),
                              child: Text(
                                  appBarController.coinsName[
                                      appBarController.coinselecter1],
                                  style: Typographyy.bodyLargeMedium
                                      .copyWith(color: notifire.getTextColor))),
                        ),
                      ),
