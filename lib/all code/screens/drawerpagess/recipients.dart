                                    ...
                                    children: [
                                      Expanded(
                                        child: PopupMenuButton(
                                          ...
                                          onOpened: () {
                                            recipientsController
                                                .setIsRecipientsType(true);
                                          },
                                          onCanceled: () {
                                            recipientsController
                                                .setIsRecipientsType(false);
                                          },
                                          offset: const Offset(0, 50),
                                          color: notifire.getContainerColor,
                                          shape: RoundedRectangleBorder(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      SvgPicture.asset(
                                          "assets/images/question-circle-outlined.svg",
                                          height: 20,
                                          width: 20,
                                          color: notifire.getGry500_600Color),
                                    ],
