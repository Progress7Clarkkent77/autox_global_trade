        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            SizedBox(
                              height: constraints.maxWidth < 600 ? 15 : 40,
                            ),
                            Text(
              ...
              SizedBox(
                height: constraints.maxWidth < 600 ? 0 : 56,
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                    ...
                    child: SizedBox(
                      ...
                      child: GridView.builder(
                        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                          crossAxisCount: constraints.maxWidth < 720 ? 2 : 4,
                          mainAxisExtent: 200,
                        ),
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: const EdgeInsets.symmetric(
                                            horizontal: 20),
                                        child: Text(title[index].toString().tr,
